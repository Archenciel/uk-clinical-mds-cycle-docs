...
export default function GroupNode ({ data }){
  ...
  return  (
    <>
    <Handle type="target" position={Position.Top} id="a" style={{ top: '50%', visibility:"hidden" }}  />
        <div
        ref={nodeRef}
        ...
        <Handle type="source" position={Position.Bottom} id="b" style={{ top: '50%', visibility:"hidden" }}   />
        {/* Left handles */}
        <Handle
            type="source"
